...
zokou({
  ...
  if (!arg[0]) {
    repondre("wrong!!! Ie. _Play hozambe by Hans tech._");
    return;
  }
...
zokou({
  ...
  if (!arg[0]) {
    repondre("insert video name Ie. _video hanstech._");
    return;
  }
...
\n\n\n ©HANSTZ`
      ...
      fileStream.on('finish', () => {
        ...
        zk.sendMessage(origineMessage, { video: { url :"./video.mp4"} , caption: "Hans tech tz", gifPlayback: false }, { quoted: ms });
      });
